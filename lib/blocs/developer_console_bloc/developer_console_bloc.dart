...
class DeveloperConsoleBloc extends Cubit<DeveloperConsoleState> {
  ...
  final List<Command> commands = [ClearCommand(), GreaterThanTimestampCommand(), LessThanTimestampCommand(), EqualTimestampCommand(), ResetCommand(), IncludeCommand(), ExcludeCommand()];
